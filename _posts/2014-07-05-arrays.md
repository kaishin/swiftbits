...
Arrays hold a collection of values with the same type. They can be declared using the bracket shorthand syntax:
...
~~~swift
starters[5] = "Mewto"
// -> ["Bulbasaur", "Charmander", "Squirtle", "Pikachu", "Articuno", "Mewto", "Moltres"]
~~~
